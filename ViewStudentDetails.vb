...
Public Class ViewStudentDetails
    ...
    End Sub
    Public Sub ViewStudentDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ConnectionTimer.Enabled = True
        TimeTimer.Enabled = True
        ActiveControl = ViewStudentDetailsPanel
        ...
        Try
            ...
            While MySqlRead.Read
                ...
                If Not IsDBNull(MySqlRead("roll_no")) Then
                    RollNoStatusLabel.ForeColor = Color.Black
                    RollNoStatusLabel.Text = MySqlRead.GetString("roll_no")
                Else
                    RollNoStatusLabel.Text = ""
                End If
                If Not IsDBNull(MySqlRead("semester")) Then
                    SemesterStatusLabel.ForeColor = Color.Black
                    SemesterStatusLabel.Text = MySqlRead.GetString("semester")
                Else
                ...
                If Not IsDBNull(MySqlRead("batch")) Then
                    BatchStatusLabel.ForeColor = Color.Black
                    BatchStatusLabel.Text = MySqlRead.GetString("batch")
                Else
    ...
    Private Sub UpdateButton_Click(sender As Object, e As EventArgs) Handles UpdateButton.Click
        Home.StudentDetails = False
        AddUpdateStudentDetails.AddStudentDetailsMenuItem.Enabled = True
        AddUpdateStudentDetails.AddButton.Visible = False
        AddUpdateStudentDetails.UpdateButton.Visible = True
        AddUpdateStudentDetails.AddUpdateStudentDetails_Load(e, e)
        AddUpdateStudentDetails.Show()
        Hide()
    End Sub
    Private Sub DeleteButton_Click(sender As Object, e As EventArgs) Handles DeleteButton.Click
        DeleteStudentDetails.DeleteStudentDetails_Load(e, e)
        DeleteStudentDetails.ShowDialog()
    End Sub
