...
Public Class ViewProfile
    ...
    End Sub
    Public Sub ViewProfile_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ConnectionTimer.Enabled = True
        TimeTimer.Enabled = True
        ActiveControl = ViewProfilePanel
        ...
        Try
            ...
            While MySqlRead.Read
                ...
                If Not IsDBNull(MySqlRead("security_question")) Then
                    SecurityQuestionStatusLabel.ForeColor = Color.Black
                    SecurityQuestionStatusLabel.Text = MySqlRead.GetString("security_question")
                Else
                    SecurityQuestionStatusLabel.Text = ""
                End If
                If Not IsDBNull(MySqlRead("security_answer")) Then
                    SecurityAnswerStatusLabel.ForeColor = Color.Black
                    SecurityAnswerStatusLabel.Text = MySqlRead.GetString("security_answer")
                Else
